...
// core/telemetry/get-tracer.ts
function getTracer({ isEnabled, getTracer: getTracer2 }) {
  if (!isEnabled) {
    return noopTracer;
  }
  if (getTracer2) {
...
async function embed({
  ...
  const tracer = getTracer({ isEnabled: (_a11 = telemetry == null ? void 0 : telemetry.isEnabled) != null ? _a11 : false, getTracer: telemetry == null ? void 0 : telemetry.getTracer });
  return recordSpan({
    name: "ai.embed",
